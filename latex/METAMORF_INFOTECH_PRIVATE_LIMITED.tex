...
\noindent\textbf{METAMORF INFOTECH PRIVATE LIMITED}\\
Bangalore Urban (Bangalore Urban / KA)\\[1em]
...
\begin{enumerate}[label=\arabic{enumi}.]
    ...
    \item \textbf{Charges}\\
        The fee is \texttt{6\%} of the candidate's annual CTC. Background verification (BGV), GST, and other specific requirements are additional.
