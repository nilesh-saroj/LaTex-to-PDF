...
\noindent\textbf{HIC IT SOLUTION AND SERVICES PRIVATE LIMITED}\\
Greater Noida (Uttar Pradesh)\\[1em]
...
\begin{enumerate}[label=\arabic{enumi}.]
    ...
    \item \textbf{Charges}\\
        The fee is \texttt{0\%} of the candidate's annual CTC. Background verification (BGV), GST, and other specific requirements are additional.
