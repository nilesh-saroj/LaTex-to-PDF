...
\noindent\textbf{WIT CAREER CONSULTING}\\
Vesu (surat)\\[1em]
...
\begin{enumerate}[label=\arabic{enumi}.]
    ...
    \item \textbf{Charges}\\
        The fee is \texttt{0.0833\%} of the candidate's annual CTC. Background verification (BGV), GST, and other specific requirements are additional.
