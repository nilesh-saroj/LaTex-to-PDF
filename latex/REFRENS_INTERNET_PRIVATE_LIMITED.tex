...
\begin{enumerate}[label=\arabic{enumi}.]
    ...
    \item \textbf{Charges}\\
        The fee is \texttt{7.5\%} of the candidate's annual CTC. Background verification (BGV), GST, and other specific requirements are additional.
